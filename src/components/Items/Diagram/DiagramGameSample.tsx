...
import type { DailyConjuntosEntry } from 'components/Daily/utils/games/daily-conjuntos';
import { type ReactNode, useState } from 'react';
import { Thing } from './Thing';

type DiagramGameSampleProps = {
  game: DailyConjuntosEntry;
};
    ...
    <Space align="center" orientation="vertical">
      ...
      <Space className="space--center">
        {playerOptions.map((thing) => (
          ...
          >
            <Thing itemId={thing.id} key={thing.id} name={thing.name} />
          </TransparentButton>
        ))}
      </Space>
...
function VennDiagram({
  ...
  return (
    <svg viewBox="0 0 760 500" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
