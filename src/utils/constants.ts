...
export const RESOURCE_NAMES = {
  ...
  ITEMS_ATTRIBUTES_VALUES: 'items-attributes',
...
export const DUAL_LANGUAGE_RESOURCES = [
  ...
  RESOURCE_NAMES.CRIME_LOCATIONS,
  RESOURCE_NAMES.CRIME_REASONS,
  RESOURCE_NAMES.CRIME_SCENES,
  RESOURCE_NAMES.CRIME_VICTIMS,
  ...
  RESOURCE_NAMES.ITEMS_ATTRIBUTES_VALUES,
  RESOURCE_NAMES.MONSTER_ORIENTATION,
  RESOURCE_NAMES.MOVIE_GENRES,
  RESOURCE_NAMES.OBJECT_FEATURES,
  RESOURCE_NAMES.SUSPECTS,
  RESOURCE_NAMES.TEENAGE_MOTIVATIONS,
